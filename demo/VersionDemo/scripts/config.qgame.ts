        ...
        if (command == 'build') {
            ...
            return {
                ...
                commands: [
                    ...
                    // new ResSplitPlugin({
                    //     matchers: [{ from: "resource/nocache/**", to: `../${projectName}_miqgame_remote` },
                    //     { from: "resource/qgame/**", to: `../${projectName}_miqgame_remote` },
                    //     { from: "resource/default.res.json", to: `../${projectName}_miqgame_remote` }
                    //     ]
                    // }),
                    // new ResPlugin(),
                    new ManifestPlugin({ output: 'manifest.js' })
